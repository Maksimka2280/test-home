...
export default function BigCard({ onEditComparison }: BigCardProps) {
    ...
    return (
        <div
            className="relative max-w-[330px] w-full min-h-[1040px] rounded-[20px] cursor-pointer"
        ...
        >
            ...
            <div className="text-center max-w-[330px] w-full">
                <div className="flex flex-col gap-6 mt-[20px]">
                    <Button color="blue" width="330px" height="60px" rounded="15px">Показать телефон</Button>
                    <ButtonBlackWhite height="60px" width="330px" rounded="15px">Написать</ButtonBlackWhite>
                </div>
