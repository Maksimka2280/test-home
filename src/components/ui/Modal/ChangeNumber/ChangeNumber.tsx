...
export default function ChangeNumber() {
    ...
    return (
        <>
            ...
            {isOpen && (
                <>
                    <div className="fixed top-0 left-0 w-full h-full bg-black opacity-50 z-40" onClick={toggleModal}></div>
                    ...
                    <div className="fixed left-1/2 transform -translate-x-1/2 bg-white z-50 w-full max-w-[580px] h-[60vh] md:h-[440px] rounded-[30px] transition-all duration-500 ease-in-out overflow-auto p-4 md:p-6">
                        <button className="absolute top-4 right-4 text-5xl text-[#BCBCBC] hover:text-black" onClick={toggleModal}>
                            ×
                        </button>
                        ...
                        <div className="flex flex-col justify-center items-center">
                            ...
                            <div className="flex gap-[20px] mt-[20px] max-w-[400px] w-full">
                                <Button width="100%" height="70px" rounded="15px" color="blue" onClick={openCodeModal}>
