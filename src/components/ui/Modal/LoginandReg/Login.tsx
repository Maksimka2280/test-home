...
export default function LoginModal() {
    ...
    return (
        <>
                    ...
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <div>
                            ...
                            <form action="" className="mt-[40px]">
                                <div className="flex flex-col gap-[20px]">
                                    <div className="relative w-full">
                                        <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500" size={14} color='#9D9D9D'/>
                                        <Input
                                            placeholder="Телефон"
                                            type="number"
                                    ...
                                    <div className="relative w-full">
                                        <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500" size={14} color='#9D9D9D'/>
                                        <Input
                                            placeholder="Пароль"
                                            type="password"
                                            className="pl-10 w-full"
                            ...
                            <div className="flex flex-col gap-[20px] mt-[20px]">
                                <Button width="100%" height="70px" rounded="15px" color="blue">Войти</Button>
                                <Button width="100%" height="70px" rounded="15px" color="blue" onClick={toggleRegisterModal}>Зарегистрироваться</Button> 
                            </div>
                            <Link href={'#'}>
            ...
            {isRegisterOpen && (
                <RegModal closeModal={closeRegisterModal} />
            )}
        </>
    );
}
